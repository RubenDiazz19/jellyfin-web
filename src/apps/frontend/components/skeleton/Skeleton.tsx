...
// Placeholders animados para cuando estamos esperando a que TMDb (o más
// tarde la API de Jellyfin) resuelva. Se muestran solo si el título todavía
// no tiene póster/backdrop cargado.
