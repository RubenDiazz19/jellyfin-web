...
import { useJellyfinShows } from '../hooks/useJellyfin';
...
export function HomePage({ navigate }: { navigate: Navigate }) {
  ...
  // En modo Jellyfin todavía no tenemos carrusel real (por implementar); se
  // oculta para no mostrar títulos del prototipo mezclados con la biblioteca.
  const slides = jellyfinMode ? [] : PROTO_DATA.carousel;
  ...
  const onPointerUp = () => {
    ...
    setPaused(false);
    void width; // ancho capturado ya cumplió su función
  };
  ...
  // Sin carrusel (modo Jellyfin de momento): saltamos el hero y pintamos
