...
import { authenticate, normalizeServerUrl } from '../api/jellyfin';
import { useToast } from '../components/toast/ToastProvider';

// Flujo de login mock: primero elegir servidor, luego usuario+contraseña.
// Al confirmar, se guarda una sesión falsa en localStorage y la app
// recarga entera desde <App>. Cuando conectemos la API real, este mismo
// componente hará las dos llamadas de verdad contra Jellyfin.
